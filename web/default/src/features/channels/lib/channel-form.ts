...
export const channelFormSchema = z
  .object({
    ...
    inject_userid_in_proxy: z.boolean().optional(),
  ...
  if (channel.setting) {
    try {
      ...
      extraSettings = {
        ...
        proxy: parsed.proxy || '',
        inject_userid_in_proxy: parsed.inject_userid_in_proxy || false,
...
function buildSettingJSON(formData: ChannelFormValues): string {
  const settingObj = {
    ...
    inject_userid_in_proxy: formData.inject_userid_in_proxy || false,
