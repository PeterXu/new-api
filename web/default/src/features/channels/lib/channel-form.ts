...
export const channelFormSchema = z
  .object({
    ...
    inject_user_id_in_proxy_url: z.boolean().optional(),
  ...
  if (channel.setting) {
    try {
      ...
      extraSettings = {
        ...
        proxy: parsed.proxy || '',
        inject_user_id_in_proxy_url: parsed.inject_user_id_in_proxy_url || false,
...
function buildSettingJSON(formData: ChannelFormValues): string {
  const settingObj = {
    ...
    inject_user_id_in_proxy_url: formData.inject_user_id_in_proxy_url || false,
